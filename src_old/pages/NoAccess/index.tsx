...
const OnlyWhitelisted = () => {
    ...
    return (
        <Box className={classes.root}>
            <img src={frame2} />
            <Typography style={{ color: palette.primary.main, fontSize: 30, fontWeight: 400, maxWidth: 600, textAlign: 'center', margin: "28px 0" }} variant="h2">You do not have access to { DAO?.name || 'this organisation' }</Typography>
